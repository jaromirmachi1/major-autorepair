...
const Cars = () => {
  ...
  // Get only pinned cars for homepage display
  const cars = allCars.filter((car) => car.pinned);
                  ...
                  <div className="relative h-full rounded-2xl overflow-hidden bg-black z-0">
                    ...
                    <div className="relative h-full flex flex-col justify-end z-10">
                      ...
                      <motion.div
                        ...
                        className="absolute top-4 right-4 px-4 py-2 rounded-lg font-bold text-sm z-20 bg-red-primary text-white"
                      >
                        {car.priceFormatted ||
                      ...
                      <div className="relative transform transition-transform duration-1000 ease-out group-hover:-translate-y-12 p-6 space-y-3 z-20">
                        <div>
